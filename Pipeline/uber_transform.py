...
def transform(df, *args, **kwargs):
    ...
    df['trip_id'] = df.index
    #first dropped the duplicates and assigned the primary key
    #Creating columns for hour, day, month, year and weekday


    #----for pickup
    datetime_dim = df[['tpep_dropoff_datetime','tpep_pickup_datetime']]
    ...
    #datetime_dim
    #Creating table for pickup location
    pickup_location_dim = df[['pickup_latitude','pickup_longitude']]
    pickup_location_dim['pickup_location_id'] = pickup_location_dim.index
    pickup_location_dim = pickup_location_dim[['pickup_location_id','pickup_latitude','pickup_longitude']]
    #pickup_location_dim
    #Creating table for dropofflocation
    drop_location_dim = df[['dropoff_latitude','dropoff_longitude']]
